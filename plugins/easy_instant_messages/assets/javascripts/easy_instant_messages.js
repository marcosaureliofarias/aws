window.EasyInstantMessaging = function (opts) {
  ...
  this.checkMessagesOnPageLoad = function() {
    const self = this

    // This only check number of unread messages
    // There is no need to duplicate whole logic of `this.checkMessages`
    EASY.backgroundServices.add("easy_instant_messages",
      function (data) {
