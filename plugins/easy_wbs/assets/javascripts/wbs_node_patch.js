...
(function () {
  ...
  WbsNodePatch.prototype.layoutGetMarginPatch = function () {
    classes.LayoutPatch.prototype.getMargin = function (ysy) {
      return ysy.settings.moneyOn ? 40 : 20;
    }
  };
  WbsNodePatch.prototype.extraElements = function ($node, selected, idea, ysy) {
    classes.NodePatch.prototype.extraElements($node, selected, idea, ysy);
    if (this.ysy.settings.moneyOn) {
      this.ysy.wbsMoney.extraElement($node, selected, idea, ysy);
    }
  };
