    ...
    Editable.prototype = {
        ...
        **/
        show: function (closeAll) {
            ...
            } else if(this.container.tip() && this.container.tip().is(':visible')) {
                return;
            }
        ...
        **/
        toggle: function(closeAll) {
            if(this.container && this.container.tip() && this.container.tip().is(':visible')) {
                this.hide();
            } else {
                this.show(closeAll);
            }
...
(function ($) {
    ...
    $.extend($.fn.editableContainer.Popup.prototype, {
        ...
        tip: function () {
            ...
            if (container) {
                var tooltip = this.container()._find(this.container().element);
                if (tooltip) {
        ...
        innerShow: function() {
            this.call('open');
            this.container().element.off("mouseleave");
