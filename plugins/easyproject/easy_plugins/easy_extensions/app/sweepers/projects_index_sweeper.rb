class ProjectsIndexSweeper < ActionController::Caching::Sweeper
...
#        expire_fragment("projects_index_user_#{user_id}")
#      end
#    elsif cached_item.is_a?(Member) && !cached_item.user.nil?
#      expire_fragment("projects_index_user_#{cached_item.user.id}")
#    end
#  end
#
end