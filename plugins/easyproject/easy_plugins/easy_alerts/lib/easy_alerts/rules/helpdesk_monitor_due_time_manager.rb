...
module EasyAlerts
  module Rules
    ...
    class HelpdeskMonitorDueTimeManager < EasyAlerts::Rules::Base
      ...
      def find_items(alert, user=nil)
        ...
        scope = Issue.joins(:status).eager_load(:project => :easy_helpdesk_project).preload(:easy_helpdesk_project_sla).
