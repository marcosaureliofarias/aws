(function () {
   ...
   * @param {number} y
   */
  ContextMenu.prototype.innerShow = async function (nodeId, x, y) {
    this.hidden = false;
    var self = this, idea;
    var ysy = this.ysy;
    var hide = function () {
    ...
    const structure = await this.getStructure(idea);
    var rendered = Mustache.render(this.template, structure);
