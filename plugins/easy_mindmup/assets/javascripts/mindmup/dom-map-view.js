  ...
  jQuery.fn.editNode = function (shouldSelectAll) {
    ...
    var node = this,
        ...
        clear = function () {
          ...
          node.removeClass("mindmup-node--renaming");
    ...
    node.addClass("mindmup-node--renaming");
    ...
    var viewPort = stageElement.parent(),
        ...
        viewportCoordinatesForPointEvent = function (evt) {
          ...
          var vpOffset = viewPort.offset(),
              result;
          if (evt.gesture) {
            var center = evt.gesture.center;
            result = {
              x: center.x - vpOffset.left,
              y: center.y + window.pageYOffset - vpOffset.top
            };
          } else {
            result = {
              x: evt.pageX - vpOffset.left,
              y: evt.pageY - vpOffset.top
            };
          }
