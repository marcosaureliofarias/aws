(function () {
  ...
  function ExpandAllButton(ysy,$parent) {
     ...
     * @type {boolean}
     */
    this.expanded= !!ysy.storage.settings._load('wbsCollapsed');
    this.ysy = ysy;
  ...
  ExpandAllButton.prototype.init= function (ysy,$parent) {
    ...
    this.$element.click(function () {
      ...
      ysy.storage.settings._save({'wbsCollapsed': self.expanded});
  ...
  ExpandAllButton.prototype._render= function () {
    this.$element.find(".mindmup-button-collapse-all").toggleClass('active');
  };
