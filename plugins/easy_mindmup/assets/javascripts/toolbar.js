(function () {
  ...
  AllIconButton.prototype.init = function (ysy, $parent) {
    ...
    var self = this;
    this.ysy.settings.allIcons = !!ysy.storage.settings._load('showIcons');
    ...
    this.$element.click(function () {
      ...
      if (ysy.settings.allIcons) {
        ...
        ysy.$container.find(".mindmup-node-icons-all_temp-icons").remove();
        ysy.$container.removeClass("mindmup-node-icons--with_icons");
      }
      ysy.storage.settings._save({'showIcons': ysy.settings.allIcons});
  ...
  StickyMenu.prototype.init = function (ysy, $element) {
    ...
    var self = this;
    var redrawMe = function () {
      ysy.repainter.redrawMe(self);
    };
    $(document).on("scroll", redrawMe);
    ysy.eventBus.register("resize", redrawMe);
    ysy.eventBus.register("sidebarResized", redrawMe);
    $("#top-menu-container-control").click(function () {
      redrawMe();
    });
    redrawMe();
    return this;
