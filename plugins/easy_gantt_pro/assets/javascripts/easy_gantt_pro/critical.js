        ...
        bind: function () {
          ...
          this._register(ysy.settings.resource);
           if (this.isOn()) {
            ...
            this.model.setSilent("open", !this.model.open);
            ysy.pro.critical.toggle(this.model.open);
          }
        },
        func: function () {
          ysy.proManager.closeAll(ysy.pro.critical);
          ...
          ysy.data.storage.savePersistentData('criticalType', critical.open);
        },
        isOn: function () {
         return ysy.main.checkForStorageValue('criticalType', ysy.settings.critical.open);
        },
        isHidden: function () {
