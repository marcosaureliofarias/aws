# -*- encoding: utf-8 -*-
# stub: easy_attendance_info_in_autocomplete 1.0.4 ruby lib

Gem::Specification.new do |s|
  s.name = "easy_attendance_info_in_autocomplete".freeze
  s.version = "1.0.4"
  ...
  s.date = "2020-11-13"
  s.description = "Description of EasyAttendanceInfoInAutocomplete.".freeze
  s.email = ["info@easysoftware.com".freeze]
  s.homepage = "https://easysoftware.com".freeze
  s.licenses = ["GPL-2.0-or-later".freeze]
  s.rubygems_version = "3.0.8".freeze
  s.summary = "Summary of EasyAttendanceInfoInAutocomplete.".freeze
