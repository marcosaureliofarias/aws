...
<!--
  ...
  --
[![coverage report](https://git.easy.cz/platform-2.0/features/easy_integrations/badges/master/coverage.svg)](https://git.easy.cz/platform-2.0/features/easy_integrations/commits/master)
  --
-->
...
source 'https://gems.easysoftware.com' do
  gem 'easy_integrations'
end

# From git server
gem 'easy_integrations', git: 'git@git.easy.cz:gems/easy_integrations', branch: 'master'
```
...
2. Add `gem 'easy_integrations', path: GENERATED_RYS_LOCATION`
