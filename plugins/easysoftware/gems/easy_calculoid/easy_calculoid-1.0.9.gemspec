# -*- encoding: utf-8 -*-
# stub: easy_calculoid 1.0.9 ruby lib

Gem::Specification.new do |s|
  s.name = "easy_calculoid".freeze
  s.version = "1.0.9"
