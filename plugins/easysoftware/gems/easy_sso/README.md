...
<!--
  ...
  --
[![coverage report](https://git.easy.cz/platform-2.0/features/easy_sso/badges/master/coverage.svg)](https://git.easy.cz/platform-2.0/features/easy_sso/commits/master)
  --
-->
...
# From git server
gem 'easy_sso', git: 'git@git.easy.cz:gems/easy_sso', branch: 'master'
```
...
2. Add `gem 'easy_sso', path: GENERATED_RYS_LOCATION`
