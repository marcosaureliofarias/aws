# -*- encoding: utf-8 -*-
# stub: easy_money_cashflow 1.0.6 ruby lib

Gem::Specification.new do |s|
  s.name = "easy_money_cashflow".freeze
  s.version = "1.0.6"
