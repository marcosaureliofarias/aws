...
<!--
  ...
  --
[![coverage report](https://git.easy.cz/platform-2.0/features/easy-redmine/badges/master/coverage.svg)](https://git.easy.cz/platform-2.0/features/easy-redmine/commits/master)
  --
-->
...
# From git server
gem 'easy-redmine', git: 'git@git.easy.cz:gems/easy-redmine', branch: 'master'
```
...
2. Add `gem 'easy-redmine', path: GENERATED_RYS_LOCATION`
