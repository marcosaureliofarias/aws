# -*- encoding: utf-8 -*-
# stub: easy-redmine 0.6.3 ruby lib

Gem::Specification.new do |s|
  s.name = "easy-redmine".freeze
  s.version = "0.6.3"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<easy>.freeze, ["~> 2.1.1"])
    else
      s.add_dependency(%q<rys>.freeze, [">= 0"])
      s.add_dependency(%q<easy>.freeze, ["~> 2.1.1"])
    end
  else
    s.add_dependency(%q<rys>.freeze, [">= 0"])
    s.add_dependency(%q<easy>.freeze, ["~> 2.1.1"])
