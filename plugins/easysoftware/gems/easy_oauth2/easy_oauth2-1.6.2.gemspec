# -*- encoding: utf-8 -*-
# stub: easy_oauth2 1.6.2 ruby lib

Gem::Specification.new do |s|
  s.name = "easy_oauth2".freeze
  s.version = "1.6.2"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<easy_sso>.freeze, [">= 0"])
      ...
      s.add_dependency(%q<easy_sso>.freeze, [">= 0"])
