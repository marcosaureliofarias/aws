...
<!--
  ...
  --
[![coverage report](https://git.easy.cz/platform-2.0/features/easy_d3/badges/master/coverage.svg)](https://git.easy.cz/platform-2.0/features/easy_d3/commits/master)
  --
-->
...
# From git server
gem 'easy_d3', git: 'git@git.easy.cz:gems/easy_d3', branch: 'master'
```
...
2. Add `gem 'easy_d3', path: GENERATED_RYS_LOCATION`
