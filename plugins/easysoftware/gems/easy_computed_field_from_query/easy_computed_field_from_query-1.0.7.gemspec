# -*- encoding: utf-8 -*-
# stub: easy_computed_field_from_query 1.0.7 ruby lib

Gem::Specification.new do |s|
  s.name = "easy_computed_field_from_query".freeze
  s.version = "1.0.7"
  ...
  s.date = "2020-11-13"
  s.description = "Description of EasyComputedFieldFromQuery.".freeze
  s.email = ["info@easysoftware.com".freeze]
  s.homepage = "https://easysoftware.com".freeze
  s.licenses = ["GPL-2.0-or-later".freeze]
  s.rubygems_version = "3.0.8".freeze
  s.summary = "Summary of EasyComputedFieldFromQuery.".freeze
