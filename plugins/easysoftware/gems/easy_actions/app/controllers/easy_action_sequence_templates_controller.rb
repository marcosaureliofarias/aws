class EasyActionSequenceTemplatesController < Easy::Redmine::BasicController

  self.entity_class       = EasyActionSequenceTemplate
  self.entity_query_class = EasyActionSequenceTemplateQuery
  ...
  def modal_index
    retrieve_query(EasyActionSequenceTemplateQuery)
