...
<!--
  ...
  --
[![coverage report](https://git.easy.cz/platform-2.0/features/resource_reports/badges/master/coverage.svg)](https://git.easy.cz/platform-2.0/features/resource_reports/commits/master)
  --
-->
...
source 'https://gems.easysoftware.com' do
  gem 'resource_reports'
end

# From git server
gem 'resource_reports', git: 'git@git.easy.cz:gems/resource_reports', branch: 'master'
```
...
2. Add `gem 'resource_reports', path: GENERATED_RYS_LOCATION`
