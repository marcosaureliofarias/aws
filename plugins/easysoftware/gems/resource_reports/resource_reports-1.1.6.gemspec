# -*- encoding: utf-8 -*-
# stub: resource_reports 1.1.6 ruby lib

Gem::Specification.new do |s|
  s.name = "resource_reports".freeze
  s.version = "1.1.6"
