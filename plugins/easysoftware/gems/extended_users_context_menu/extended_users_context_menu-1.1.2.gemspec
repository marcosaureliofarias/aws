# -*- encoding: utf-8 -*-
# stub: extended_users_context_menu 1.1.2 ruby lib

Gem::Specification.new do |s|
  s.name = "extended_users_context_menu".freeze
  s.version = "1.1.2"
