...
ysy.main.extender(ysy.view.Widget, ysy.view.Affix, {
  ...
  init: function () {
    ...
    this.stickyAllowed = this.isStickyAllowed();
  },
  ...
  _repaintCore: function () {
    ...
    if (this.stickyAllowed) {
      this.$target[0].style.cssText = "position:sticky;position:-webkit-sticky;position:-ms-sticky;top:"+this.offset+"px";
      this.$cont.find(".gantt_hor_scroll").css({position: "sticky", bottom: "0"});
    } else {
