module EasyGantt
  ...
  def self.dont_escape_custom_fields
    @dont_escape_custom_fields ||= ['flag']
  end

  def self.cf_formats_to_delete_from_query
    %w(easy_google_map_address text enumeration list attachment value_tree easy_lookup link)
  end
end
