...
class MoveToRequirementAndRemoveReAttachment < ActiveRecord::Migration[4.2]

  def self.up
    ReArtifactProperties.unscoped.where(artifact_type: "ReAttachment").each do |artifact|
